		...
		<div id="navigation">
			...
			<ul>
				<c:forEach items="${categoryList}" var="category">
					<li <c:if test="${categoryNo eq category.no}">class='selected'</c:if>>
						<a href="${pageContext.request.contextPath}/${blogVo.blogId}/${category.no}">${category.title}(${category.postCount})</a>
					</li>
				</c:forEach>
			</ul>
		</div>
